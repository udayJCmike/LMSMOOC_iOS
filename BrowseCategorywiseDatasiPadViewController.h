//
//  BrowseCategorywiseDatasiPadViewController.h
//  LMSMOOC
//
...
@interface BrowseCategorywiseDatasiPadViewController :UIViewController<MBProgressHUDDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
{
