//
//  BrowseCourseListViewController.h
//  LMSMOOC
//
...
@interface BrowseCourseListViewController : UIViewController<MBProgressHUDDelegate,UITableViewDataSource,UITableViewDelegate>
{
    UIView* footerView;
