//
//  BrowseCourseSearchiPadViewController.h
//  LMSMOOC
//
...
@interface BrowseCourseSearchiPadViewController : UIViewController<MBProgressHUDDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UITextFieldDelegate>
{
