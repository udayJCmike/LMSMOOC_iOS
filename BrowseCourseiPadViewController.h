//
//  BrowseCourseiPadViewController.h
//  LMSMOOC
//
...
@interface BrowseCourseiPadViewController : UIViewController<MBProgressHUDDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIPopoverControllerDelegate>
{
...
@property(nonatomic,retain)IBOutlet UICollectionView *ipadcollection;
@end
