   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.textColor = [UIColor colorWithRed:66.0/255.0 green:139.0/255.0 blue:202.0/255.0 alpha:1];
        ...
        self.alertContentLabel.textColor = [UIColor colorWithRed:66.0/255.0 green:139.0/255.0 blue:202.0/255.0 alpha:1];
        self.alertContentLabel.font = [UIFont systemFontOfSize:12.0f];
        self.alertContentLabel.lineBreakMode = NSLineBreakByWordWrapping;
        [self addSubview:self.alertContentLabel];
        
        CGRect leftBtnFrame;
        CGRect rightBtnFrame;
#define kSingleButtonWidth 130.0f
...
#define kButtonBottomOffset 10.0f
      ...
      //  [UIColor colorWithRed:87.0/255.0 green:135.0/255.0 blue:173.0/255.0 alpha:1]
        [self.rightBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:127/255.0f green:127/255.0f blue:127/255.0f alpha:1.0f]] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithRed:66/255.0f green:139/255.0f blue:202/255.0f alpha:1.0f]] forState:UIControlStateNormal];
