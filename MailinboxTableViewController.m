...
- (void)viewDidLoad
{
 ...
 inbox=[[NSArray alloc]initWithObjects:@"inbox 1",@"inbox 2", nil];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"mailinbox" forIndexPath:indexPath];
