//
//  MyauthorcoursesViewController.h
//  LMSMOOC
//
...
@interface MyauthorcoursesViewController : UIViewController <MBProgressHUDDelegate,UITableViewDataSource,UITableViewDelegate>
{
