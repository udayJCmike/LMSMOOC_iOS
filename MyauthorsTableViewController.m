...
- (void)viewDidLoad
{
    ...
    myauthors=[[NSArray alloc]initWithObjects:@"author1",@"author 2", nil];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myauthors" forIndexPath:indexPath];
    
   
    cell.textLabel.text=[myauthors objectAtIndex:indexPath.row];
    return cell;
}
