//
//  MycategoriesTableViewController.m
//  LMSMOOC
//
...
@interface MycategoriesTableViewController ()

@end

@implementation MycategoriesTableViewController
...
- (void)viewDidLoad
{
    ...
    mycategories=[[NSArray alloc]initWithObjects:@"cat1",@"cat 2", nil];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"mycategories" forIndexPath:indexPath];
    
    
    cell.textLabel.text=[mycategories objectAtIndex:indexPath.row];
    return cell;
}
