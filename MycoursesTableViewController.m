...
- (void)viewDidLoad
{
  ...
  mycourses=[[NSArray alloc]initWithObjects:@"course 1",@"course 2", nil];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"mycourse" forIndexPath:indexPath];
    
    
    cell.textLabel.text=[mycourses objectAtIndex:indexPath.row];
    return cell;
}
